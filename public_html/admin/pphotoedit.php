...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "deleteform")) {
  $updateSQL2 = sprintf("DELETE FROM projectsp WHERE Project=%s and Photo=%s",
  ...
  unlink("projectsp/chico/".$_POST['Foto'] );
  unlink("projectsp/grande/".$_POST['Foto'] );
  header("Location: pphotoedit.php?Project=".$p);
}
?>
...
<title>Project Photo Edit</title>
...
{
    var pro='agregar_project.php?Project=<?php echo $p;?>';
        ...
        do {
            ...
            <!-- Photoos!-->
             <tr>
                ...
                <td>
                <a rel="example_group" href="projectsp/grande/<?php echo $nombre;?>" title=""><img alt="" src="projectsp/chico/<?php echo $nombre;?>" style="border: none;" /></a>
                </td>
