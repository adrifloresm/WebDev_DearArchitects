...
$target_path= "projectsp/".$nombre_archivo1;
...
$target_path= "projectsp/".$nombre_archivo2;
...
$target_path= "projectsp/".$nombre_archivo3;
...
$target_path= "projectsp/".$nombre_archivo4;
...
$target_path= "projectsp/".$nombre_archivo5;
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1"))  {
  ...
  $insertSQL = sprintf("INSERT INTO projectsp (Project , Photo) VALUES (%s,%s)",
  ...
  if (isset($_SERVER['QUERY_STRING'])) {   
    echo "<script language=javascript>window.opener.location = 'pphotoedit.php?Project=".$p."';window.close();</script>";
  }
}
...
function move() {
    window.opener.location = 'pphotoedit.php?Project=<?php echo $p;?>';
    window.close();
}
