...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1"))  {
  $insertSQL = sprintf("INSERT INTO years_aca (year) VALUES (%s)",
...
if ((isset($_POST["MM_delete"])) && ($_POST["MM_delete"] == "form2"))  {
  $insertSQL = sprintf("DELETE FROM years_aca WHERE year=%s ",
...
//Info Years
mysql_select_db($database_Base, $Base);
$query_yr =  sprintf("SELECT year FROM years_aca order by year DESC");
...
<body>
        <p class="titulos" style="padding-top: 5px;">New Year</p>
        ...
        <p class="titulos" style="padding-top: 5px;">Delete Year</p>
        <table border="0" cellpadding="0" cellspacing="5"  class="addproject"  >
