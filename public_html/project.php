...
$query =  sprintf("SELECT * FROM projects where Project=%s",GetSQLValueString( $p, "text"));
$pro = mysql_query($query, $Base) or die(mysql_error());
$row_pro = mysql_fetch_assoc($pro);

//Info fotos
mysql_select_db($database_Base, $Base);
$query_fotos =  sprintf("SELECT * FROM projectsp where Project=%s order by Photo ASC",GetSQLValueString($p, "text"));
...
<html>
	<head>
		...
		<meta http-equiv="Content-type" content="text/html; charset=utf-8">
                ...
                <meta name="title" content="Dear Architects/ <?php echo $p;?>" />
...
<!--[if gte IE 5.5]><script language="JavaScript" src="jquery.ienav.js" type="text/javascript"></script><![endif]-->
		...
		<script type="text/javascript" src="SLIDER/js/jquery.opacityrollover.js"></script>
                ...
                document.getElementById("projectst").style.color="black";
                });
                </script>
...
<div id="wrapper">
    <div id="leftcolumn">
        ...
        <div id="info">
            <div><span class="t">Year</span><span><?php echo $row_pro['Year']; ?></span></div>
            <div><span class="t">Plot</span><span><?php echo $row_pro['Plot']; ?></span></div>
            <div><span class="t">Foot Print</span><span><?php echo $row_pro['FootPrint']; ?></span></div>
            <div><span class="t">Built Area</span><span><?php echo $row_pro['BuiltArea']; ?></span></div>
            <div><span class="t">Team</span><span><?php echo $row_pro['Team']; ?></span></div>
        </div>
        <div id="detalles">
     ...
     <div id="cuadrado">
      <div id="social">
            <span>
              <img onclick="tweet('<?php echo $p;?>')" style="cursor:pointer;" src="Twitter.jpg" title="Share on Twitter"/>
            </span>
            <span>
              <img onclick="face('<?php echo $p;?>')" style="cursor:pointer;" src="Facebook.jpg" title="Share on Facebook"/>
            </span>
      </div>
                <div id="titulop">
                    <?php echo $p; ?>
					...
					<div id="thumbs" class="navigation">
						...
						<ul class="thumbs noscript">
                                                    <?php
                                                     ...
                                                     ?>
							<li>
								<a class="thumb"  href="admin/projectsp/grande/<?php echo $nombre;?>">
									<img src="admin/projectsp/chico/<?php echo $nombre;?>" alt=""/>
								</a>
							</li>
